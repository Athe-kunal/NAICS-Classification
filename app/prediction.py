...
class Prediction(PredictionAbstract):
    ...
    def query_database(self,query_embeddings:list[list[float]],parent_or_child:Literal['parent','child'],parent_names:list = []):
    ...
    def pipeline(self, question: str):
        ...
        assert len(entities)>=1, "Expected atleast one entity. Try changing the threshold or the labels for better NER"
